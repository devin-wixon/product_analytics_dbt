...
final as (
    ...
    select
        ...
        district_grades,
        rostering_method,
        rostering_classlink_id,
        rostering_clever_id,
        is_onboarding_required,
        rostering_upload_method,
        rostering_rostering_type,
        rostering_state_id_field,
        rostering_is_active_send_invite,
        is_rostering_allow_users_without_class_or_school,
        is_selfservice_rostering_show_clever,
        is_selfservice_authentication_show_clever,
        authentication_provider,
        authentication_login_field,
        authentication_classlink_settings_classlink_id,
        authentication_clever_settings_clever_id,
        authentication_clever_settings_provider_name,
        authentication_saml_settings_provider_name,
        authentication_saml_settings_metadata_document_file,
        authentication_saml_settings_metadata_document_source,
        user_pool_client_id
