...
{% docs event_type %}
Used in reporting. The hardcoded higher-level group for the `event_category` value, generated by the macro `assign_event_type`. Examples include: Error, Navigation, and more.
{% enddocs %}
